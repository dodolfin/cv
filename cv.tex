...
\begin{center}
    ...
    Fahrenheitstrasse 19-25 (A.4.4.1), 28359 Bremen, Germany \\ \vspace{1pt}
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Kotlin, Java, Dart, Python, C++} \\
     \textbf{Technologies}{: Linux, Git, Flask, PostgreSQL, MySQL, Docker, Elasticsearch} \\
