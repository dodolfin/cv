...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {JetBrains}{December 2023 -- Present}
      {Intern at MPS}{Germany}
      \resumeItemListStart
        \resumeItem{Working on the copy-paste feature (MPS uses a projectional editor, so it is quite difficult to copy-paste from text sources).}
      \resumeItemListEnd

    \resumeSubheading
      {virtuetech GmbH}{July 2023 -- November 2023}
      {Student Developer}{Bremen, Germany}
      \resumeItemListStart
        \resumeItem{Set up production server monitoring with ELK stack.}
        \resumeItem{Fixed form elements and syncronization in the Dart/Flutter mobile application.}
      \resumeItemListEnd
