...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Saint Petersburg State University}{2021 — June 2022}
      {Bachelor of Computer Science in Applied Mathematics and Computer Science}{}
    \resumeSubheading
      {Jacobs University, Bremen}{September 2022 — Expected 2024}
...
\section{Skills \& Relevant Coursework}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: C++ (courses Programming in C \& C++), Kotlin (courses Object-Oriented Programming, Programming in Kotlin), Python} \\
     \textbf{Developer Tools}{: IntelliJ IDEA, Git} \\
     \textbf{Technologies}{: Linux, Databases \& Web Services [\textit{currently attending}]} \\
     \textbf{Computer Science \& Maths}{: Algorithms \& Data~Structures (courses ADS Part 1, Advanced ADS Part 1 [\textit{currently attending}]), Calculus~(Parts 1 \& 2), Algebra~(Parts 1 \& 2))}
    }}
 \end{itemize}
 \vspace{-16pt}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Is able to produce output in normal (Linux-like) and unified (GitHub-like) modes.}
          \resumeItemListEnd

      \resumeProjectHeading
          {\href{https://github.com/dodolfin/c-cpp-homework}{\textbf{C, C++ Homework}} $|$ \emph{C, C++}}{Since November 2021}
          \resumeItemListStart
            \resumeItem{Unfortunately, it's forbidden by the rules of the course to make homework solutions publicly accessible in the Internet. I may add you as a collaborator on the e-mail. \href{https://drive.google.com/file/d/1ib23DhRDuYS8YUAsHL0pgDelphTkBTYT/view?usp=sharing}{\underline{.zip repo (in Russian)} } }
            \resumeItem{C homeworks: Makefile, implementation of some functions from cstring, mergesort implementation, intrusive list implementation. C++ homeworks: vector implementation, shared\_ptr, C++ I/O, vector implementation.}
